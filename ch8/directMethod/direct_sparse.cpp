...
class EdgeSE3ProjectDirect: public BaseUnaryEdge< 2, Eigen::Vector2d, VertexSE3Expmap>
{
public:
    ...
    virtual void computeError()
    {
        ...
        {
            Eigen::Vector2d obsv(0.0, 0.0);
            _error = obsv;
            this->setLevel ( 1 );
        }
        else
        {
            Eigen::Vector2d obsv(getPixelValue ( x,y ), getPixelValue ( x,y ));
    ...
    virtual void linearizeOplus( )
    {
        ...
        Eigen::Matrix<double, 2, 2> jacobian_pixel_uv;

        jacobian_pixel_uv ( 0,0 ) = ( getPixelValue ( u+1,v )-getPixelValue ( u-1,v ) ) /2;
        jacobian_pixel_uv ( 0,1 ) = ( getPixelValue ( u,v+1 )-getPixelValue ( u,v-1 ) ) /2;

        jacobian_pixel_uv ( 1,0 ) = ( getPixelValue ( u+1,v )-getPixelValue ( u-1,v ) ) /2;
        jacobian_pixel_uv ( 1,1 ) = ( getPixelValue ( u,v+1 )-getPixelValue ( u,v-1 ) ) /2;
...
int main ( int argc, char** argv )
{
    ...
    for ( int index=0; index<2; index++ )
    {
        ...
        bool success = poseEstimationDirect ( measurements, &gray, K, Tcw );
...
bool poseEstimationDirect ( const vector< Measurement >& measurements, cv::Mat* gray, Eigen::Matrix3f& K, Eigen::Isometry3d& Tcw )
{
    ...
    // auto solver = new g2o::OptimizationAlgorithmGaussNewton(g2o::make_unique<DirectBlock>(g2o::make_unique<LinearSolverType>()));
    ...
    for ( Measurement m: measurements )
    {
        ...
        edge->setMeasurement ( Eigen::Vector2d(m.grayscale, m.grayscale) );
